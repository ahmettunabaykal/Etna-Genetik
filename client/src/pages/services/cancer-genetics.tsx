...
const CancerGeneticsPage = () => {
  return (
    <ServiceDetailPage
      ...
      heroImage="https://images.unsplash.com/photo-1579154392429-0e6b4e450f40?ixlib=rb-1.2.1&auto=format&fit=crop&w=2850&q=80"
      description={[
      ...
      faqs={[
        {
          ...
          answer: "ETNA Genetik olarak, tüm solid tümörler (meme, akciğer, kolorektal, prostat, over, melanoma vb.) ve hematolojik maligniteler (lösemi, lenfoma vb.) için kapsamlı genetik testler sunuyoruz. Test portföyümüz sürekli genişlemekte ve en son bilimsel gelişmeleri takip etmektedir."
        },
        {
        ...
        },
        {
          ...
          answer: "Test tipine bağlı olarak, sonuçlar genellikle 7-14 iş günü içinde hazır olur. Acil durumlarda, özel hızlandırılmış hizmet sunabiliyoruz, bu durumda sonuçlar 5-7 iş günü içinde teslim edilebilir. Test süreci başladığında, size tahmini bir sonuç tarihi verilecektir."
        },
        {
      ...
      cta={{
        ...
        description: "ETNA Genetik Kanser Testleri ile tümörünüzün genetik profilini çıkarın ve sizin için en etkili tedavi seçeneklerini belirleyin. Kanser tedavisinde kişiselleştirilmiş yaklaşımın gücünden yararlanın."
      }}
    />
  );
};
